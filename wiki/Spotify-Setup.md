...
> **Placeholder** — full guide: [docs/spotify-setup.md](https://github.com/Paco5687/WinAmpPlayer/blob/main/docs/spotify-setup.md)
...
2. **Web API** (browse/control) — PKCE → `python -m winamp_player.authorize`.
